...
('Pesticides', 'pesticides', '🛡️', 3),
('Herbicides', 'herbicides', '🌿', 4),
('Fungicides', 'fungicides', '🔬', 5),
('Insecticides', 'insecticides', '🐛', 6),
('Growth Promoters', 'growth-promoters', '📈', 7),
('Organic Farming', 'organic-farming', '🌿', 8),
('Irrigation', 'irrigation', '💧', 9),
('Farm Tools', 'farm-tools', '🔧', 10),
('Animal Husbandry', 'animal-husbandry', '🐄', 11),
('Smart Farming', 'smart-farming', '📱', 12);
